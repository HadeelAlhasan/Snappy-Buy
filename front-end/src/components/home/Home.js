...
import home from "../../photo/home.jpg";
...
export default function Home() {
	...
	return (
		<div>
			<NavBar blod="home" />
			<img className="imghome"  src={home} alt="no thing" />
			<div className={`text-photo ${isEnglish?"text-photo-en":"text-photo-ar"}`}>
			...
			<div className="how-work">
				<div className="how-work-div">
					<p data-aos={dir}  className="how-work-p">{t("how-work.title")}</p>
					<p data-aos={dir} data-aos-duration="1510">1- {t("how-work.dis1")}</p>
					<p data-aos={dir} data-aos-duration="1520">2- {t("how-work.dis2")}</p>
					<p data-aos={dir} data-aos-duration="1530">3- {t("how-work.dis3")}</p>
					<p data-aos={dir} data-aos-duration="1540">4- {t("how-work.dis4")}</p>
					<p data-aos={dir} data-aos-duration="1550">5- {t("how-work.dis5")}</p>
				</div>
                <div>
                    <img data-aos={dir1} className="how-work-img" src={home1} alt="no thing"/>
                </div>
			</div>
            <div className="Advantages">
                 <div>
                    <img data-aos={dir} className="Advantages-img" src={home2} alt="no thing"/>
                </div>
				<div className="Advantages-div">
					<p data-aos={dir1} className="Advantages-p">{t("Advantages.title")}</p>
					<p data-aos={dir1} data-aos-duration="1510">1- {t("Advantages.dis1")}</p>
					<p data-aos={dir1} data-aos-duration="1520">2- {t("Advantages.dis2")}</p>
					<p data-aos={dir1} data-aos-duration="1530">3- {t("Advantages.dis3")}</p>
					<p data-aos={dir1} data-aos-duration="1540">4- {t("Advantages.dis4")}</p>
		...
		<div className="group-photo-div2" >
			...
			<p className="group-photo-p" data-aos="fade-up" data-aos-duration="1550">{t("end")}</p>
		</div>
			<Footer />
		</div>
	);

...
import img2 from "../../photo/back.jpg";
...
export default function EditPage() {
  ...
  //       <div className="con_fix_direction">
  //         <img src={img2} alt="err" />
  //         <button>اختر صورة</button>
  //       </div>
  //       <div className="con_input">
  //         <input type="text" placeholder="أدخل اسم المجموعة باللغة العربية" />
  //         <input
  //           type="text"
  //           placeholder="أدخل اسم المجموعة باللغة الإنجليزية"
  //         />
  //         <textarea type="text" placeholder="أدخل الوصف باللغة العربية" />
  //         <textarea type="text" placeholder="أدخل الوصف باللغة الإنجليزية" />
  //         <button className="creat_Group1">إنشاء المجموعة</button>
  //         <button className="exit1">X</button>
  //       </div>
  //     </div>
  //   </>
  // );
        ...
        <div className="col">
          <div className="width-product2">
            ...
            <p className={`${dir === "en" ? "des-area-en" : "des-area"}`}>
              {t("product.des")}
              <textarea placeholder={t("grp1")} />
            </p>
            <p className={`${dir === "en" ? "des-area-en" : "des-area"}`}>
              {t("product.des")}
              <textarea placeholder={t("grp2")} />
            </p>
          </div>

		...
		<div className="group" data-aos="fade-up">
			...
			<div className="col">
				...
				<div className="width-product">
					<p>
						{t("product.name")} <span>ملابس</span>
					</p>
					<p>
						{t("product.price")}
						<span className="old">11111111111111111$</span>
						<span>4444422222222222222222224444$</span>
					</p>
					<p>
						{t("product.des")}
						<span>
							جميع المقاسات اقمشة و الوان مختلفالمقاسات اقمشة و الوان
							مختلفالمقاسات اقمشة و الوان مختلفالمقاسات اقمشة و الوان
							مختلفالمقاسات اقمشة و الوان مختلفالمقاسات اقمشة و الوان
							مختلفالمقاسات اقمشة و الوان مختلفالمقاسات اقمشة و الوان
							مختلفالمقاسات اقن مختلفة
						</span>
					</p>
				</div>
				<div className="star">

        ...
        <div  className="privacy">
               <div className="gotohome">
                ...
                <div className="privacy-eternal">
                    ...
                    <div >
                        <p data-aos={dir} className={` ${visible?"visible":""}`}>{t("dis2")}</p>
                        <ul>
                            ...
                            <li data-aos={dir} className={` ${visible?"visible":""}`}>{t("li21")}</li>
                             <li data-aos={dir} className={` ${visible?"visible":""}`}>{t("li22")}</li>
                              <li data-aos={dir} className={` ${visible?"visible":""}`}>{t("li23")}</li>
                        </ul>
                    </div>
                      <p data-aos={dir} className={`privacy-title1 ${visible?"visible":""}`}>3- {t("title3")}</p>
                    <div >
                        <p data-aos={dir} className={` ${visible?"visible":""}`}>{t("dis3")}</p>
                        <ul>
                    ...
                    <div >
                        <p data-aos={dir} className={` ${visible?"visible":""}`}>{t("dis4")}</p>
                    
                    </div>
                      <p data-aos={dir} className={`privacy-title1 ${visible?"visible":""}`}>5- {t("title5")}</p>
                    <div >
                        <p data-aos={dir} className={` ${visible?"visible":""}`}>{t("dis5")}</p>
                    
                    </div>

                    <p data-aos={dir} className={`privacy-title1 ${visible?"visible":""}`}>6- {t("title6")}</p>
                    <div >
                        <p data-aos={dir} className={` ${visible?"visible":""}`}>{t("dis6")}</p>
                        <ul>
                    ...
                    <div >
                        <p data-aos={dir} className={` ${visible?"visible":""}`} >{t("dis7")}</p>

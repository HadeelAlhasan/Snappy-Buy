	...
	return (
		<div className="nav">
			...
			<div className="ulnav">
				<ul className="nav">
					<li>
						<Link to="/" style={{ fontWeight: blod === "home" ? "bold" : "" }}>
							{t("nav.h")}
						</Link>
					</li>
					<li>
						<Link
							to="/group"
							style={{ fontWeight: blod === "group" ? "bold" : "" }}
						>
							{t("nav.g")}
						</Link>
					</li>
					<li>
						<Link
							to="/card"
							style={{ fontWeight: blod === "cart" ? "bold" : "" }}
						>
							{t("nav.c")}
						</Link>
					</li>
					<li>
						<Link to={"/login"}>{t("nav.p")}</Link>
					</li>
				</ul>
			</div>
			<div className="nav1">
			...
			<div className={`serach-div ${opt ? "open" : "close"}`}>
				<input type="search" />
			</div>
		</div>
	);
